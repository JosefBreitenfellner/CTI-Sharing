...
function connectToBlockchain(){
  ...
  if(status == true) {
    ...
    */
    const contractAdress = '0xB34f2bC892Dd471C90fa412992343a2c6a3e6914';
  ...
  if(contractInstance == null) {
    ...
    loadJSON('./Cti-Files/' + fileName, function(text){
      ...
      for(i in data) {
        ...
        */
        contractInstance.methods.setObjects(data[i].id, data[i].created, data[i].modified, data[i].description).send({ from: '0xb6CF4EC94f87EEC4Fe7BC95Cb105B3e2fAD2d36C', gas:3000000 });
      }
    });
  }
}
...
function displayCTI() {
  ...
  if(contractInstance == null) {
    ...
    // table body is stored in table
    var table = document.getElementById("table");
    // reset table to prevent mutiple output
    table.innerHTML = "";
...
/*
downloadCsv and exportTableToCsv are functions found on https://codepen.io/malahovks/pen/gLxLWX
*/
